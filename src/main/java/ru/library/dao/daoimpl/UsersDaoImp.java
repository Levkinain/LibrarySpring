...
public class UsersDaoImp implements Dao {
    ...
    public static final String SQL_FIND_USER_AND_ROLE = "SELECT ru.ruUser as login , r.nameRole as authority FROM RoleUser ru LEFT JOIN Role r on ru.ruRole = r.rId  WHERE ru.ruUser = ? ";
    ...
    public User findUserByLogin(String login) {
        Object[] params = new Object[] { login };
            return  jdbcTemplate.queryForObject(SQL_FIND_USERS_BY_LOGIN, new UserMapper(),params);
    }

/*    public List<String> getUserRole(String login) {
        Object[] params = new Object[] { login };
        List<String> roles = jdbcTemplate.queryForList(SQL_FIND_USER_ROLE,params, String.class);
        return roles;
    }*/
